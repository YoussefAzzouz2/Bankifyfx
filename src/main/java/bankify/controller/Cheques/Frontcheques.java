package bankify.controller.Cheques;


import bankify.models.Cheques.Cheque;
import bankify.models.Cheques.Reclamation;
import bankify.models.User;
import bankify.services.Cheques.Cheques;
import bankify.services.Cheques.Reclamations;
...
import static bankify.controller.Cheques.cheques.list;
...
populateComboBox();
    ...
    public void update() {
        ...
        try {
            ...
            boolean isComboBox22Valid = !DestinationC1.getValue().getName().equals("..");
            ...
            try {
                if (!isMonatantValid) {
                    ...
                    boolean isComboBox2Valid = !DestinationC1.getValue().getName().equals("..");
    ...
    public void populateComboBox() {
        try {
            ...
            try (Statement statement1 = connection.createStatement();
                 ResultSet resultSet1 = statement1.executeQuery("SELECT id,nom, prenom FROM user")) {
                ...
                while (resultSet1.next()) {
                    ...
                    items2.add(new User(id, name));
                    items3.add(new User(id, name));
...
// Assuming comboBox2 is your ComboBox<User>
    ...
    void add() {
        ...
        try {
            ...
            boolean isComboBox22Valid = !DestinationC.getValue().getName().equals("..");
            ...
            try {
                ...
                boolean isComboBox2Valid = !DestinationC.getValue().getName().equals("..");
...
void addfill()
{
    DestinationC.getSelectionModel().select(new User(0,".."));
